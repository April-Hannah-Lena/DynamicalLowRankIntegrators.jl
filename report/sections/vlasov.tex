...
Equation \ref{eq:vlasov} contains infinitely many invariants. Indeed, all $L^p$
norms $\left\| f \right\|_p$ as well as entropy are conserved
\cite{MORRISON1980383,CROUSEILLES2015224}. Additionally it can be shown that all
moments of the velocity distrbution
...
space-integrals $\scrM_k = \int_{\Omega_x} M_k\, dx$ are also of interest. Specifically, 
